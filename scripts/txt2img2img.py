...
#from txt2img2img.dependencies import shortcodes @@reason: shortcodes is included in python 3.10. also, this throws an exception no module named txt2img2img. if you just want shortcodes, use that instead
import shortcodes
